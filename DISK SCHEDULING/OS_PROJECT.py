...
def LIFO(arr,head,directions,mi_cyl,ma_cyl,num):    
    ...
    #mylabel=Label(root,text=a).grid(row=4,column=1)
    print(seek_counts)

    #arr.insert(0,initial_head)
    if num=="2":
            report.delete("1.0","end")
            report.insert(INSERT,a)
            report.insert(INSERT,x_array[1:])
...
def comman2():
        tex.delete("1.0","end")
        a=variables.get()
        li=[118, 59, 110, 25, 105, 63, 100, 28, 80]
        if a=="LIFO":
        ...
        l=[118, 59, 110, 25, 105, 63, 100, 28, 80]
        if a=="LIFO":
...
k3 = Label(my_frame2,text = " Enter Request Points :").grid(row=3,column=0)

v = StringVar(my_frame2, value='default text')
inputtxt2 = Text(my_frame2, height = 3,width = 25,bg = "lightgreen")
inputtxt2.grid(row=3,column=1)
inputtxt2.insert(INSERT,"118, 59, 110, 25, 105, 63, 100, 28, 80")
inputtxt2.config(state="disabled")

blank1 = Label(my_frame2,text = " ").grid(row=0,columnspan=2)
b0=Label(my_frame2,text = " ").grid(row=0,column=1)
variables.set("LIFO") # default value

k1 = Label(my_frame2,text = "Select the Algorithm :").grid(row=1,column=0)

w = OptionMenu(my_frame2, variables, "LIFO", "SSTF", "SCAN","CSCAN","LOOK","CLOOK","FCFS").grid(row=1,column=1)

button = Button(my_frame2, text="RUN", command=comman2,padx=85).grid(row=15,column=1)
blank4 = Label(my_frame2,text = " ").grid(row=2,column=0)
b2=Label(my_frame2,text = " ").grid(row=2,column=1)
blank2 = Label(my_frame2,text = " ").grid(row=4,column=0)
b4=Label(my_frame2,text = " ").grid(row=4,column=1)
head = Label(my_frame2,text = "Intial Head Position :").grid(row=5,column=0)
head_text = Text(my_frame2,height=1,width = 25,bg = "lightgreen")
head_text.grid(row=5,column=1,padx=50)
head_text.insert(INSERT,"50")
head_text.config(state="disabled")
blank5 = Label(my_frame2,text = " ").grid(row=6,column=0)
b6=Label(my_frame2,text = " ").grid(row=6,column=1)
variable1.set("RIGHT")
direction = Label(my_frame2,text = "Direction:").grid(row=7,column=0)
direction_op = Text(my_frame2,height=1,width = 25,bg = "lightgreen")
direction_op.grid(row=7,column=1)
direction_op.insert(INSERT,"RIGHT")
direction_op.config(state="disabled")

blank6 = Label(my_frame2,text = " ").grid(row=8,column=0)
b8=Label(my_frame2,text = " ").grid(row=8,column=1)
max_cyl = Label(my_frame2,text = "Maximum Cylinder :")
max_cyl.grid(row=9,column=0)
maxcyl_text2 = Text(my_frame2,height=1,width = 25,bg = "lightgreen")
maxcyl_text2.grid(row=9,column=1)
maxcyl_text2.insert(INSERT,"200")
max_cyl.config(state="disabled")
blank7 = Label(my_frame2,text = " ").grid(row=10,column=0)
b10=Label(my_frame2,text = " ").grid(row=10,column=1)
min_cyl = Label(my_frame2,text = "Minimum Cylinder :")
min_cyl.grid(row=11,column=0)
mincyl_text2 = Text(my_frame2,height=1,width = 25,bg = "lightgreen")
mincyl_text2.grid(row=11,column=1)
mincyl_text2.insert(INSERT,"0")
mincyl_text2.config(state="disabled")

answer = Label(my_frame2,text = "Answer :")
answer.grid(row=13,column=0)
blank3 = Label(my_frame2,text = " ").grid(row=12,column=0)
b12=Label(my_frame2,text = " ").grid(row=12,column=1)
blank8 = Label(my_frame2,text = " ").grid(row=14,column=0)
blank8 = Label(my_frame2,text = " ").grid(row=16,column=0)
blank16 = Label(my_frame2,text = " ").grid(row=17,column=0)
...
blank1 = Label(my_frame3,text = " ").grid(row=0,column=0)
k3 = Label(my_frame3,text = " Enter Request Points :").grid(row=1,column=0)

inputtxt3 = Text(my_frame3, height = 3,width = 25,bg = "light yellow")
inputtxt3.grid(row=1,column=1)
blank2 = Label(my_frame3,text = " ").grid(row=2,column=0)

head3 = Label(my_frame3,text = "Intial Head Position :").grid(row=3,column=0)
head_text3 = Text(my_frame3,height=1,width = 25,bg = "light yellow")
head_text3.grid(row=3,column=1,padx=50)

blank3 = Label(my_frame3,text = " ").grid(row=4,column=0)

variable3.set("RIGHT")
direction3 = Label(my_frame3,text = "Direction:").grid(row=5,column=0)
direction_op3 = OptionMenu(my_frame3, variable3, "RIGHT", "LEFT").grid(row=5,column=1)
blank4 = Label(my_frame3,text = " ").grid(row=6,column=0)

max_cyl3 = Label(my_frame3,text = "Maximum Cylinder :").grid(row=7,column=0)
maxcyl_text3 = Text(my_frame3,height=1,width = 25,bg = "light yellow")
maxcyl_text3.grid(row=7,column=1)

blank5 = Label(my_frame3,text = " ").grid(row=8,column=0)

min_cyl3 = Label(my_frame3,text = "Minimum Cylinder :").grid(row=9,column=0)
mincyl_text3 = Text(my_frame3,height=1,width = 25,bg = "light yellow")
mincyl_text3.grid(row=9,column=1)
blank6 = Label(my_frame3,text = " ").grid(row=10,column=0)




k11 = Label(my_frame3,text = "Select the Algorithm").grid(row=11,column=0)
k22 = Label(my_frame3,text = "Total Seek Time").grid(row=11,column=1)


blank7 = Label(my_frame3,text = " ").grid(row=12,column=0)
...
T9=Label(my_frame3,text = "The best algorithm for the given value is ").grid(row=20,column=0)
